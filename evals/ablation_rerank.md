...
**Retrieval stages:** rerank (`BAAI/bge-reranker-v2-m3`, depth 50) (every arm ran under this stack)

Same test set (`evals/testset.json`), same LLM, same top_k; only the retriever feeding the RAG chain changes. Full per-question detail for each configuration is in `results_<retriever>_rerank.md`.
...
|-----------|----------|-----|----------------|-------------------|----------|--------|-------------|-------------|---------------|----------|----------|---------|
| vector | 0.8095 | 0.6841 | 0.5604 | 0.4047 | 43 | 0 | 2.3s | 3.1s | 836 | 1.5s | 2.0s | 43 |
| bm25 | 0.7857 | 0.6833 | 0.5847 | 0.4093 | 43 | 0 | 2.2s | 2.8s | 841 | 1.5s | 1.7s | 43 |
| hybrid | 0.8095 | 0.7032 | 0.5269 | 0.4093 | 43 | 0 | 2.3s | 3.1s | 840 | 1.6s | 2.2s | 43 |
